...
![Хранилище отработанного топлива.](/uploads/029-spent-fuel-pool/pool_geometry_ru.png "хранилище отработанного топлива")
...
![Изображение, показывающее части бассейна, в которых не следует плавать.](/uploads/029-spent-fuel-pool/pool_danger_ru.png)
...
![Отказ от ответственности: я карикатурист. Если вы последуете моему совету насчёт безопасности радиоактивных материалов, то вы, вероятно, заслуживаете всего того, что с вами произойдёт.](/uploads/029-spent-fuel-pool/pool_safe_ru.png)
...
![Самая зловещая продуктовая корзинка в мире.](/uploads/029-spent-fuel-pool/pool_diver.png)
