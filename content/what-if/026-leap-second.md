...
Раздражает в том числе и потому, что стандарты времени из-за этого становятся всё сложнее. У нас и так [слишком много временных стандартов][1], включая:
...
**[Вращение против часовой стрелки][2] на стуле**. Это временно изменит скорость вращения Земли, но недостаточно, чтобы это имело значение..
...
**Вызывать большие землетрясения.** Это может [изменять продолжительность дня][3], но даже такие землетрясения не будут достаточно мощными, чтобы что-то изменить.
...
[^1]: [Секунда координации][5]
[^2]: [Международное атомное время][6]
[^3]: [Всемирное время][7]
...
[^5]: [Международное координированое время][8]
[^6]: [Динамическое время][9]
[^7]: [Приливные силы][10]
[^8]: [Маленький принц][11]
...
[6]: http://ru.wikipedia.org/wiki/TAI

[7]: http://ru.wikipedia.org/wiki/Всемирное_время

[8]: http://ru.wikipedia.org/wiki/UTC

[9]: http://ru.wikipedia.org/wiki/Динамическое_время

[10]: http://ru.wikipedia.org/wiki/Приливные_силы

[11]: http://ru.wikipedia.org/wiki/Маленький_принц
