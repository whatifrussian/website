...
![Вопрошающий ожидает, когда птичка залетит.](/uploads/011-droppings/droppings_setup_ru.png)
...
![Изображение, показывающее трубку с топливом, положенную вдоль всего маршрута машины.](/uploads/011-droppings/droppings_car_ru.png)
