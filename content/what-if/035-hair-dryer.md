...
Равновесная температура[^1] будет несколько меньше, если во внешней среде есть ветер, либо коробка находится на мокрой или металлической поверхности, которая быстро отводит тепло.
...
Коробка, парящая высоко над поверхностью, выделяет энергию, эквивалентную таковой при трех испытаниях «Тринити»[^2], проходящих каждую _секунду_.
