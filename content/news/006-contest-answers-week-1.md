...
Плотность грибов, разумеется, зависит от их вида. Немного поискав, я нашёл следующие цифры: от 200\ г/л до 1,67\ кг/л. (один из [примеров](http://otvety.google.ru/otvety/thread?tid=1f29d5a33208e84d)) Возьмём среднюю величину: это будет 0,935\ кг/л = 0,935\ т/м^{3}.
